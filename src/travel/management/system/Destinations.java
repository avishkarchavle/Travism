...
public class Destinations extends JFrame implements Runnable{
    ...
    public void run(){
        String[] text = new String[]{"JW marriot","Maratha","Sukhsagar","Chai Sutta Bar","Taj","Sunshine","Ramashrya","Rashtriya","Adarsh","Jayka"};
    ...
    Destinations(){
        ...
        jimage[i] = image[i].getImage().getScaledInstance(1600,1000,Image.SCALE_DEFAULT);
        kimage[i] = new ImageIcon(jimage[i]);
        label[i] = new JLabel(kimage[i]);
        label[i].setBounds(0,0,1600,1000);
